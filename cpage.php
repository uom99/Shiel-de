          ...
          <div class="collapse float-none" id="collapseExample" style="">
            <div class="card card-body">
              <small class="d-block text-first">
                <a class="btn btn-sm btn-link" href="cpage_modify.php">내 정보 수정</a>
              </small>
              <small class="d-block text-first">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
          ...
          <div class="pb-3 mb-0 small lh-sm w-100 h-100">
            ...
            <div class="myboard">
              <table class="table table-hover mt-1" style="border: 1px solid #ddddda">
                ...
                <?php
                    $sql = "select * from board where c_num='$usernum';";
    ...
    $b_sql = "SELECT * FROM board where c_num='$usernum' order by idx desc limit $page_start, $list;";
    $b_result = mysqli_query($conn,$b_sql);
            ...
            <div class="myreply" style="display:none">
              <table class="table table-hover mt-1" style="border: 1px solid #ddddda">
                <tr>
                  <th style="background-color: #ddffff; text-align: center;">번호</th>
                  <th style="background-color: #ddffff;">카테고리</th>
                ...
                <?php
                    $sql = "select * from reply where c_num='$usernum';";
                    $result = mysqli_query($conn,$sql);
                    $total_record =  mysqli_num_rows($result); // 게시판 총 레코드 수z
                    $list = 10; // 한 페이지에 보여줄 개수
                    $block_cnt = 5; // 블록당 보여줄 페이지 개수
                    ...
                    $r_sql = "SELECT * FROM reply where c_num='$usernum' order by idx desc limit $page_start, $list;";
            ...
            <div class="mylikes" style="display:none">
              <table class="table table-hover mt-1" style="border: 1px solid #ddddda">
                <tr>
                  <th style="background-color: #ddffff; text-align: center;">번호</th>
                  <th style="background-color: #ddffff;">카테고리</th>
              ...
              while($likes = mysqli_fetch_array($l_result)){
                ...
                <tr class="read_check" style="cursor:pointer" data-action="read.php?idx=<?=$bl_user['idx']?>">
                  ...
                  <td width="300"><?=$bl_user['title']?><span class="text-danger" style="font-size:14px">
                      [<?=$rep_count?>]</span>
                  </td>
