<?php
  ...
  $sql = "select * from company where (c_id='$id' and c_name='$uname' and c_tel='$phone');";
  ...
  <div class="container">
    <div id="modal" class="modal-overlay">
      <div class="modal-window">
        ...
        <div class="mb-1"></div>
        <div class="mb-1">
          <button class="btn btn-primary btn-block float-end" id="join_btn" type="submit">변경완료</button>
