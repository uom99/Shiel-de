      ...
      <div class="container w-100 h-100 mt-5 pt-2">
        <div id="board_area"> <br>
          <div class="nav w-100 dropdown mt-1">
					<a href="#" data-bs-toggle="dropdown" role="button" class="fs-5 btn btn-dark w-100 dropdown-toggle" id="board_text">리뷰</a>
          ...
          <tr>
            ...
            $bc = "<script>document.write (bc);</script>";
			    	...
			    	$sql = "select * from board where category='리뷰';";
            // $sql = "<script>document.write(sql)</script>";
			    	...
			    	$sql2 = "select * from board where category='리뷰' order by idx desc limit $page_start, $list"; 
            ...
            <ul class="pagination justify-content-center">
              <?php
				    	if ($page <= 1){
				    		...
				    		echo "<li class='page-item'><a class='page-link' href='b_review.php.php?page=1'> &laquo; </a></li>";
				    	}
				    	...
				    	if ($page <= 1){
				    		...
				    		$pre = $page - 1;
				    		echo "<li class='page-item'><a class='page-link' href='b_review.php?page=$pre'> < </a></li>";
				    		
				    	}
				    	
				    	for($i = $block_start; $i <= $block_end; $i++){
				    		if($page == $i){
				    			echo "<li class='page-item active'><a class='page-link' href='b_review.php?page=$i'> $i </a></li>";
				    		} else {
				    			echo "<li class='page-item'><a class='page-link' href='b_review.php?page=$i'> $i </a></li>";
				    		}
				    	}
				    	...
				    	if($page >= $total_page){
				    		...
				    		$next = $page + 1;
				    		echo "<li class='page-item'><a class='page-link' href='b_review.php?page=$next'> > </a></li>";
				    	}
					   	
				    	if($page >= $total_page){
				    		// 빈 값
				    	} else {
				    		echo "<li class='page-item'><a class='page-link' href='b_review.php?page=$total_page'> &raquo; </a></li>";
				    	}
					?>
            </ul>
          </div>
